...
from utils.contrastive import contrastive_loss
...
class MACLLearner:
    ...
    def train(self, batch: EpisodeBatch, batch_ssl: EpisodeBatch, t_env: int, episode_num: int):
        td_loss, consensus_loss = self.calc_loss(batch, t_env, episode_num)
    ...
    def calc_loss(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        consensus_loss = contrastive_loss(hidden_states)

        return td_loss, consensus_loss
